...
There are a few ways to connect with the `cable_thermal_model` project:

* Submit an issue
* Send an email to the Technical Steering Committee: <cable-thermal-model@alliander.com>.
...
`cable_thermal_model`, but there's not yet reason to suspect you've
